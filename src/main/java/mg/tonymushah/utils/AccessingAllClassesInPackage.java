...
public class AccessingAllClassesInPackage {
  ...
  public static <T extends Annotation> Set<Class<?>> findAllClassesByClassAnnotation(String packageName, Class<T> annotation) throws PackageNotFoundException {
  ...
  public static Set<Class<?>> findAllClassesByClassAnnotations(String packageName, Class<? extends Annotation>... annotation) throws PackageNotFoundException {
    Set<Class<?>> all_classes = AccessingAllClassesInPackage.findAllClasses(packageName);
    all_classes.removeIf(new Predicate<Class<?>>() {
